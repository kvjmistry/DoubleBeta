...
mkdir -p /media/argon/HardDrive_8TB/Krishan/NEXT100Data/alpha/sipm_baselines/${RUN_NUMBER}/
cd       /media/argon/HardDrive_8TB/Krishan/NEXT100Data/alpha/sipm_baselines/${RUN_NUMBER}/
...
python /home/argon/Projects/Krishan/DoubleBeta/Alphas/notebooks/StudySiPMBaselines.py $input_file ${RUN_NUMBER}
